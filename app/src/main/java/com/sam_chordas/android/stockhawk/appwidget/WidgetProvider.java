...
public class WidgetProvider extends AppWidgetProvider {
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            views.setOnClickPendingIntent(R.id.flWidget, pendingIntent);
            ...
            views.setPendingIntentTemplate(R.id.lvWidget, clickPendingIntentTemplate);
            views.setEmptyView(R.id.lvWidget, R.id.tvWidgetEmptyList);
    ...
    private void setRemoteAdapter(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(R.id.lvWidget,
    ...
    private void setRemoteAdapterV11(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(0, R.id.lvWidget,
                new Intent(context, WidgetRemoteViewsService.class));
    }
}
